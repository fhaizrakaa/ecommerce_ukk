...
<div style="margin-bottom:20px;">
    ...
    <textarea id="alamat" name="alamat"
        ...
        style="width:100%; padding:14px; border:1px solid #fce4ec; border-radius:12px; outline:none; background:white; font-family:inherit; resize:vertical;"></textarea>
</div>
</div>
...
@media (max-width: 768px) {
    ...
    /* item produk jadi lebih fleksibel */
